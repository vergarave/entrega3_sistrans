...
public interface ProductoRepository extends JpaRepository<Producto, Integer>{
    ...
    "LEFT JOIN PRODUCTO_PROVEEDOR ON PRODUCTO.IDENTIFICADOR = PRODUCTO_PROVEEDOR.IDENTIFICADOR_PRODUCTO \r\n" +
    "LEFT JOIN PROVEEDOR ON PRODUCTO_PROVEEDOR.NIT_PROVEEDOR = PROVEEDOR.NIT \r\n" +
